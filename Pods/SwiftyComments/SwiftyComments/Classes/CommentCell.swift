    ...
    open var commentViewContent: UIView? {
        get {
            ...
            if v != nil {
                ...
                v!.trailingAnchor.constraint(equalTo: commentView.trailingAnchor, constant: -10).isActive = true
                v!.leadingAnchor.constraint(equalTo: commentView.leadingAnchor, constant: 10).isActive = true
